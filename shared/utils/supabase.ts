...
export async function getUser(discordid: string): Promise<interfaces.User | undefined> {
  try {
...
export async function getLatestUsersStats(): Promise<interfaces.UserStats[] | undefined> {
  try {
